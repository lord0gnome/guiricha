...
#    Updated: 2015/12/03 16:09:16 by guiricha         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_NAME = ft_isalpha.c ft_memccpy.c ft_putchar.c ft_strcpy.c ft_strncat.c \
		   ...
		   ft_strlcat.c ft_strrchr.c ft_bzero.c ft_isspace.c ft_memmove.c \
		   ft_strchr.c ft_strlcpy.c ft_strstr.c ft_isalnum.c ft_memalloc.c \
